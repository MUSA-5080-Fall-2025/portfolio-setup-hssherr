...
- Output values are probabilities of an event occurring
  ...
  - If you classify a potential spam email with a probability of 0.72 as spam, but it actually was not, what does that say about the cutoff?
Confusion Matrices
...
- Goal is to maximize AUC (area under the curve) value
Handling Large Amounts of Zeros
